...
import { MonitorType } from './properties';
...
export interface MonitorFormulaAndFunctionEventQueryGroupBy {
   ...
   */
  readonly sort?: MonitorFormulaAndFunctionEventQueryGroupBySortBy;
}

export interface MonitorFormulaAndFunctionEventQueryGroupBySortBy {
